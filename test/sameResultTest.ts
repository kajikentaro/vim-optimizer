...
function newTestGeneric<T extends SameReulstTestObject | ITestWithRemapsObject>(
  testObj: T,
...
export const newCompare = (testObj: SameReulstTestObject) => newTestGeneric(testObj, test, testIt);
